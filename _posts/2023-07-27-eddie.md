...
## Robot Communication: **$$ \textcolor{#8E4585}{\texttt{eddiebot\_ bringup}} $$**
...
## Description: \texttt{$$ \textcolor{#8E4585}{eddiebot_description} $$}
...
## Simulation: $$ \textcolor{#8E4585}{\texttt{eddiebot\_ gazebo}} $$
...
## Custom Interfaces: $$ \textcolor{#8E4585}{\texttt{eddiebot\_ msgs}} $$
...
## Odometry: $$ \textcolor{#8E4585}{\texttt{eddiebot\_ odom}} $$
...
To keep track of Eddie’s pose (position and orientation) over time, the node continuously updates the transformation between two frames: the <mark style="textcolor:green;">`/odom`</mark> frame and the <mark style="textcolor:green;">`/base_footprint`</mark> frame.
...
## Visualization: $$ \textcolor{#8E4585}{\texttt{eddiebot\_ rviz}} $$
...
## Velocity: $$ \textcolor{#8E4585}{\texttt{eddiebot\_ vel\_ controller}} $$
...
## SLAM and Navigation: $$ \textcolor{#8E4585}{\texttt{eddiebot\_ nav}} $$
